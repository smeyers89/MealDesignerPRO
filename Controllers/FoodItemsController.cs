...
namespace MealDesignerPRO.Controllers
{
    public class FoodItemsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,Calories,Carbs,Fat,Type,Time")] FoodItem foodItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,Calories,Carbs,Fat,Type,Time")] FoodItem foodItem)
        {
            if (ModelState.IsValid)
            {
